...
if (isset($_POST["btnsubmit"]))
{
    ...
    $sql = "INSERT INTO tblEmp (fname,lname,email,gender,ninumber) VALUES ('".$first_name."','".$last_name."','".$email."','".$gender."','".$ninumber."');";
...
<body>
    <center>
        ...
        <h1>Employee Registragion From</h1> 
            ...
            <table>
                ...
                <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" name="btngender" value="others">other
                        </td>
                </tr>
                <tr>
                        <td>NI Number:</td>
